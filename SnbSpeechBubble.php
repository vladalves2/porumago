...
class SnbSpeechBubble {
	...
	private $sb_reg_type     = array( 'std', 'fb', 'fb-flat', 'ln', 'ln-flat', 'pink', 'rtail', 'drop', 'think', 'mago1', 'mago2','sakura1','sakura2');
	...
	*/
	public function shortcode_speech_bubble( $atts, $content = '' ) {
      ...
      if ($this->sb_reg_type[9] == $sb_type){//mago1
          $sb_type = $this->sb_reg_type[7]; //drop
          $sb_subtype = $this->sb_asc_subtype['L1'];
          $user_icon = 'IMG_0210.PNG';
          $sb_name = 'mago先生';
        } else if ($this->sb_reg_type[10] == $sb_type){//mago2
        	$sb_type = $this->sb_reg_type[7]; //drop
            $sb_subtype = $this->sb_asc_subtype['L1'];
            $user_icon = 'IMG_0195.PNG';
            $sb_name = 'mago先生';
      	} else if ($this->sb_reg_type[11] == $sb_type){//sakura1
        	$sb_type = $this->sb_reg_type[7]; //drop
            $sb_subtype = $this->sb_asc_subtype['R1'];
            $user_icon = 'IMG_0208.PNG';
            $sb_name = 'さくら';
      	} else if ($this->sb_reg_type[12] == $sb_type){//sakura2
        	$sb_type = $this->sb_reg_type[7]; //drop
            $sb_subtype = $this->sb_asc_subtype['R1'];
            $user_icon = 'IMG_0197.PNG';
            $sb_name = 'さくら';
      	}
